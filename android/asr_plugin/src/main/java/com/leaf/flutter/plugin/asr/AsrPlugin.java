package com.leaf.flutter.plugin.asr;
...
public class AsrPlugin implements FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler {
    private final static String TAG = "AsrPlugin";
    private final static String PLUGIN_NAME = "com.leaf.flutter.plugin.asr";
    ...
    public static void registerWith(PluginRegistry.Registrar registrar) {
        MethodChannel channel = new MethodChannel(registrar.messenger(), PLUGIN_NAME);
